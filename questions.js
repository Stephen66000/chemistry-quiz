...
const QUESTIONS = [
  ...
  },
  {
    ...
    altAnswers: [
      'S+O₂=点燃=SO₂;明亮的蓝紫色火焰，放热，生成有刺激性气味的气体',
      'S+O2=点燃=SO2;发出明亮的蓝紫色火焰，放热，产生刺激性气味气体',
      'S+O2=点燃=SO2;明亮蓝紫色火焰，放热，生成刺激性气味气体',
      'S+O2=点燃=SO2;蓝紫色火焰，放热，生成刺激性气体'
    ],
  ...
  {
    id: 'q312', kpId: 'X001', type: 'choice', difficulty: 1,
    stem: '氧化反应的本质特征是？',
    options: [
      'A. 必须与氧气反应',
      'B. 物质与氧发生的化学反应',
    ...
    answer: 'B',
    explanation: '氧化反应定义：物质与氧发生的反应（不一定是 O₂，如 CuO 中的氧也算）。与化合反应是交叉关系，不存在包含关系。',
    relatedKps: ['X001', 'M008']
  },
  {
  ...
  {
    id: 'q313', kpId: 'X002', type: 'choice', difficulty: 3,
    stem: '下列实验现象的描述中，正确的是？',
    options: [
      'A. 铁丝在氧气中燃烧，发出白光，生成白色固体',
      'B. 硫在空气中燃烧，发出蓝紫色火焰，生成有刺激性气味的气体',
      'C. 红磷在空气中燃烧，产生大量白烟',
      'D. 木炭在氧气中燃烧，发出红光，生成二氧化碳'
    ],
    answer: 'C',
    explanation: 'A：铁丝在 O₂ 中火星四射，生成黑色固体 Fe₃O₄ ✗；B：硫在空气中是淡蓝色火焰（氧气中才是蓝紫色）✗；C ✓；D：木炭在 O₂ 中是白光不是红光 ✗。',
    relatedKps: ['X002', 'M008', 'M029']
  },
  ...
  {
    id: 'q314', kpId: 'T001', type: 'choice', difficulty: 2,
    stem: '下列各组物质混合后，不能发生复分解反应的是？',
    options: [
      'A. 稀盐酸和 Na₂CO₃ 溶液',
      'B. Ba(OH)₂ 溶液和稀 H₂SO₄',
      'C. NaOH 溶液和 KNO₃ 溶液',
    ...
    answer: 'C',
    explanation: '复分解反应条件：生成物中需有沉淀↓、气体↑或水。A 生成 CO₂↑+H₂O ✓；B 生成 BaSO₄↓+H₂O ✓；C 产物 NaNO₃+KOH 全可溶无气无水 ✗ 不发生；D 生成 AgCl↓ ✓。',
    relatedKps: ['T001', 'M021']
  },
  {
  ...
  {
    id: 'q315', kpId: 'T002', type: 'choice', difficulty: 3,
    stem: '配制 50g 10% 的 NaCl 溶液，以下哪组操作错误会导致溶质质量分数偏大？',
    options: [
      'A. 称量 NaCl 时，左盘放砝码、右盘放 NaCl（使用了游码）',
      'B. 量取水时仰视量筒读数',
      'C. 将配好的溶液转移到试剂瓶时有少量洒出',
      'D. 称量时砝码生锈变重'
    ],
    answer: 'D',
    explanation: 'A：放反+用游码 → 实际 NaCl = 砝码−游码，NaCl 偏少 → 偏小 ✗；B：仰视 → 实际水量偏多 → 偏小 ✗；C：溶液均匀，洒出不影响质量分数 ✗；D：砝码偏重 → 要加更多 NaCl 才能平衡 → NaCl 偏多 → 偏大 ✓。',
    relatedKps: ['T002']
  },
...
const HINTS = {
  ...
  'q312': '氧化反应的定义关键词：与"氧"发生反应。注意不一定是 O₂ 这个分子——CuO 里的氧也算。',

  // X002 火焰颜色
  'q099': '硫在氧气中（不是空气）。空气淡蓝，氧气蓝紫——记口诀"空气淡蓝、氧气蓝紫"。',
  'q100': '"耀眼白光" = 镁。其他：铁火星四射（不是火焰）、硫蓝紫/淡蓝、氢气淡蓝。',
  'q313': '逐项检查：①铁在 O₂ 中是火星四射还是白光？产物颜色？②硫在空气中是什么颜色火焰？③磷燃烧产物是烟还是雾？④木炭在 O₂ 中是什么色的光？',

  // T001 复分解
  'q101': '复分解条件——生成物有沉淀/气/水。逐项看。CuSO₄+NaOH 生 Cu(OH)₂↓ 蓝色沉淀。',
  'q314': '复分解条件：生成物要有气↑、沉淀↓或水。把每组产物写出来，看哪组什么都没生成。',
  ...
  'q315': '偏大=溶质偏多或溶剂偏少。天平放反用了游码→NaCl偏少→偏小；仰视量筒→水偏多→偏小；洒出均匀溶液→浓度不变；砝码生锈变重→需多加NaCl平衡→偏大。',
